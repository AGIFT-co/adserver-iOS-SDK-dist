...
> **プレリリース版（`v1.0.0-rc.1` など）を検証する場合**: `from:` は semver 仕様によりプレリリースタグを解決しません。次のように該当バージョンを正確に指定してください。
>
> ```swift
> .package(url: "https://github.com/AGIFT-co/adserver-iOS-SDK-dist.git", exact: "1.0.0-rc.1")
> ```
